...
export const ru = {
  ...
  watchNotes: "Заметки",
  watchNotesPlaceholder: "Почему вы следите за этой акцией?",
  adding: "Добавление...",
  add: "Добавить",
  ...
  stockDetailsTabs: "Разделы данных об акции",
  chartTab: "График",
  stockInfoTab: "Данные акции",
  companyInfoTab: "Данные компании",
  ...
  peRatio: "P/E",
  eps: "EPS",
  fiftyTwoWeekHigh: "Максимум за 52 недели",
  fiftyTwoWeekLow: "Минимум за 52 недели",
  sector: "Сектор",
  industry: "Отрасль",
  exchange: "Биржа",
  country: "Страна",
  ...
  currentStockPrice: "Текущая цена",
  currentValue: "Текущая стоимость",
  profitLoss: "Прибыль/убыток",
  profitLossUsd: "Прибыль (USD)",
  profitLossPercent: "Прибыль %",
  currency: "Валюта",
  ...
  transactionTypeRequiredError: "Выберите BUY или SELL.",
  transactionDateRequiredError: "Укажите дату сделки.",
  futureTransactionDateError: "Дата сделки не может быть в будущем.",
  editTransactionFormValidationError: "Исправьте выделенные поля перед сохранением.",
  ...
  invalidPhoneNumber: "Введите действительный номер телефона с кодом страны.",
