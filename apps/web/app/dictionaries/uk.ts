...
export const uk = {
  ...
  watchNotes: "Нотатки",
  watchNotesPlaceholder: "Чому ви відстежуєте цю акцію?",
  adding: "Додавання...",
  add: "Додати",
  ...
  stockDetailsTabs: "Розділи даних про акцію",
  chartTab: "Графік",
  stockInfoTab: "Дані акції",
  companyInfoTab: "Дані компанії",
  ...
  currentStockPrice: "Поточна ціна",
  currentValue: "Поточна вартість",
  profitLoss: "Прибуток/збиток",
  profitLossUsd: "Прибуток (USD)",
  profitLossPercent: "Прибуток %",
  currency: "Валюта",
  ...
  transactionTypeRequiredError: "Виберіть BUY або SELL.",
  transactionDateRequiredError: "Вкажіть дату угоди.",
  futureTransactionDateError: "Дата угоди не може бути в майбутньому.",
  editTransactionFormValidationError: "Виправте виділені поля перед збереженням.",
  ...
  phoneNotSet: "Телефон: не вказано.",
  status: "Статус",
  verified: "Підтверджено",
  notVerified: "Не підтверджено",
  invalidPhoneNumber: "Введіть дійсний номер телефону з кодом країни.",
